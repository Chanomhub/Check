...
var translate2 = _interopDefault(require('@iamtraction/google-translate'));
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return bingTranslator.translate(safeValueTransition(str), from, to, false);
          case 2:
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return googleTranslateApi.translate(safeValueTransition(str), {
              from: from,
              to: to,
              fetchOptions: {
...
var queue = /*#__PURE__*/new cwait.TaskQueue(bluebird.Promise, default_concurrency_limit);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            global.proxyIndex = 0;
            global.proxyList = [];
            program.version(current_version).addHelpText('beforeAll', messages.cli.welcome).description(messages.cli.description).usage(messages.cli.usage).addOption(new commander.Option("-m, --module <Module>", messages.cli.module).choices(translationModuleKeys())).addOption(new commander.Option("-f, --from <Language>", messages.cli.from)).addOption(new commander.Option("-t, --to <Languages...>", messages.cli.to)).addOption(new commander.Option("-n, --name <string>", messages.cli.new_file_name)).addOption(new commander.Option("-fb, --fallback <string>", messages.cli.fallback).choices(Object.keys(fallbacks))).addOption(new commander.Option("-cl, --concurrencylimit <number>", messages.cli.concurrency_limit)).addHelpText('after', "\n" + messages.cli.usage_with_proxy + "\n" + messages.cli.usage_by_ops).addHelpText('afterAll', supportedLanguagesUrl);
